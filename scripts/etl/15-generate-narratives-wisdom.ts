// 15-generate-narratives-wisdom.ts — Insert pre-baked Layer 2D narrative units for Wisdom/Poetry Books
import { db, heading, log } from './db'
import type { NarrativeUnitRecord } from './data/narrative-types'

import { narrativesJob } from './data/narratives-job'
import { narrativesPsalms } from './data/narratives-psalms'
import { narrativesProverbs } from './data/narratives-proverbs'
import { narrativesEcclesiastes } from './data/narratives-ecclesiastes'
import { narrativesSongOfSolomon } from './data/narratives-song-of-solomon'

const ALL_NARRATIVES: NarrativeUnitRecord[] = [
  ...narrativesJob,
  ...narrativesPsalms,
  ...narrativesProverbs,
  ...narrativesEcclesiastes,
  ...narrativesSongOfSolomon,
]

function main(): void {
  heading('Importing Layer 2D — Narrative Units (Wisdom/Poetry)')
